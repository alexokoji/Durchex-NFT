 ...
 *
 * Resale opens on its own the moment the collection is fully minted, so
 * this is a progress note rather than a decision anyone is waiting on —
 * the copy avoids implying the creator could open it sooner.
 */
  ...
  return (
    <div className="flex flex-wrap items-center gap-x-2 gap-y-1 rounded-xl border border-white/10 bg-white/[0.02] px-4 py-3">
      ...
      <span className="text-xs text-white/45">
        Buying the floor and making collection offers open automatically once this collection is
        fully minted
