...
export function AssetUploader({ value, onChange, imageOnly = false, label = "Upload your NFT asset" }: { value: UploadedAsset | null; onChange: (asset: UploadedAsset | null) => void; imageOnly?: boolean; label?: string }) {
