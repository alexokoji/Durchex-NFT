...
// route, secret-gated — delete after use, same pattern as prior cleanups.
const TEST_SLUG_PATTERN =
  /^(concurrent-phase-test|e2e-full-test|live-buy-now-demo|phase-gate-test|pipeline-test|repro|resale-test|race-test|resale-royalty-check|sellout-debug)-/;
